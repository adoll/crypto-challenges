...
def sha1(message, h0=0x67452301, h1=0xEFCDAB89, h2=0x98BADCFE, h3=0x10325476,
         h4=0xC3D2E1F0):
    ...
    """
    # don't add padding here, because explicitly adding padding makes this
    # attack easier to visualize (imo)
    # Pre-processing:
